...
from dataclasses import dataclass  ##Generally use for daata storing
...
class Dataingestion:
    ...
    def initiate_data_ingestion(self):  ## This class generally doo read data from data base
        ...
        try:
            ...
            logging.info("Inginationnof data is completed")
